...
export default function UnderDevelopmentOverlay({ children }: { children: ReactNode }) {
  return (
    <div className="relative">
      ...
      {/* Fixed over main content (sidebar offset on md+) — stays on top while scrolling */}
      <div
        className="fixed inset-0 md:left-52 z-40 pointer-events-auto"
        aria-hidden="true"
      >
      ...
      <div
        className="fixed inset-0 md:left-52 z-50 flex items-center justify-center pointer-events-none p-4"
        aria-live="polite"
      >
